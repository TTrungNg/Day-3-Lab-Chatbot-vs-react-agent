...
| `check_interaction` | Input: `drug1, drug2: string` → trả về `{"interaction": "dangerous"/"low"/"unknown", ...}` |
...
| Hỏi liều trẻ em 10kg        | Đoán theo training data      | `calculate_dose()` → 100–150mg |
